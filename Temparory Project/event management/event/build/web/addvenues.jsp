<%-- 
    Document   : addvenues
    Created on : Apr 18, 2019, 5:16:06 PM
    Author     : Dell
--%>
...
<html lang="en">
    ...
    <body style=text-align:center;>
       ...
       <div id="preloader">
        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h4>Information</h4>
                    <a href="#">Related</a>
                    <a class="active" href="#"> ADD Venues </a>
                </div>
            </div>
        </section>
        <!--================End Banner Area =================-->
        ...
        <form action="addvenues"method="post"> 
        <div style=align-text:center>
             <br> <br> <h1 style=color:red>ADD VENUES </h1> <br> <br>
            
             <label for="Eventname"> <b>Event Name :&nbsp;&nbsp;&nbsp;&nbsp;   </b> </label>
       <input type="text" name="ename" style=width:20%; required> <br><br>
       
        <label for="eventtype"> <b> Event Place:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b>  </label>
        <input type="text" name="etype" style=width:20%; required> <br><br> <br>
