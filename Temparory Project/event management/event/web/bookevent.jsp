<%-- 
    Document   : bookevent
    Created on : Apr 18, 2019, 5:22:41 PM
    Author     : Dell
--%>
...
<html lang="en">
    ...
    <body style=text-align:center;>
        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    <h4>Information</h4>
                    <a href="#">Related</a>
                    <a class="active" href="#">booking event</a>
                </div>
            </div>
        </section>
        <!--================End Banner Area =================-->
       ...
       <table>
           <br> <br>  
           <h1 style=color:red>BOOK AN EVENT </h1> <br><br>
...
%>
       ...
       <input type="text" name="id" value="<%=s1%>" style=width:20%; /> <br><br>
       
       <label for="deptname"> <b>Dept Name :&nbsp;&nbsp;&nbsp;&nbsp;   </b> </label>
       <input type="text" name="deptname" placeholder="enter dept name" style=width:20%; required> <br><br>
       <label for="event"> <b> Event Type:&nbsp;&nbsp;&nbsp;&nbsp;</b>  </label>
        <select name="eventtype" style=width:20%; required> 
            <option value="selecte event"> select event name</option>
           <%
           ...
           <label for="eventplace"> <b> Event Place:&nbsp;&nbsp;</b>  </label>
        <select name="eventplace" style=width:20%; required>
            <option value="selecte Place"> select event place</option>
        ...
        <input type="text" name="capacity" placeholder="Enter capacity" style=width:20%; required> <br> <br>
        
         <label for="capacity"> <b>Date : &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b> </label>
         <input type="date" name="date" placeholder="Fill date" style=width:20%; required> <br> <br>
        
         
          <label for="time"> <b> Beg. Time : &nbsp;&nbsp;&nbsp; </b> </label>
          <input type="time" name="begtime" placeholder="Fill time" style=width:20%; required> <br> <br>
          <label for="time"> <b> End Time : &nbsp;&nbsp;&nbsp; </b> </label>
          <input type="time" name="endtime" placeholder="Fill time" style=width:20%; required> <br> <br>
          
          
          <input type="submit" value="Book Event" style=width:20%,color-red; >  <br> <br><br><br><br><br>
