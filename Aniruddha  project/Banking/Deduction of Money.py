...
def submit():
    ...
    if a[1] == a1 and a[len(a)-1] == b1:
        ...
        Label(frame1,text="Withdrawal Some Money:").grid(row=10,column=0)
        ...
        conn.commit()
        messagebox.showinfo("Sananive Bank..","Money Withdrawal Successfully...")
    else:
...
Label(frame1,text="Withdrawal Money.").grid(row=1,column=1)
