...
class Pair1 {
	...
	Pair1(Character position, int n, LinkedList<String> list) {
...
public class Input2 {
	...
	static public void input() throws Exception{
		String filepath = "E:\\JAVA code n material\\SelfPratice\\src\\GoogleHashCode\\b_lovely_landscapes.txt";
 		FileInputStream fis = new FileInputStream(filepath);
		dis = new DataInputStream(fis);
		LinkedList<String> list;
		HashMap<Integer, Pair1> map = new HashMap<Integer, Pair1>();
		Pair1 psan = null;
		int photos = 0;
		...
		FileWriter fos = new FileWriter("Output2.txt");
