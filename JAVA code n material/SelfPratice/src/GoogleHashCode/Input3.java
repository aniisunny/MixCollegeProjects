...
class Pair2 {
	...
	Pair2(Character position, int n, LinkedList<String> list) {
...
public class Input3 {
	...
	static public void input() throws Exception{
		String filepath = "E:\\JAVA code n material\\SelfPratice\\src\\GoogleHashCode\\c_memorable_moments.txt";
 		FileInputStream fis = new FileInputStream(filepath);
		dis = new DataInputStream(fis);
		LinkedList<String> list;
		HashMap<Integer, Pair2> map = new HashMap<Integer, Pair2>();
		Pair2 psan = null;
		int photos = 0;
		...
		FileWriter fos = new FileWriter("Output3.txt");
